...
tf.app.flags.DEFINE_string(
    'output_file', '/home/linux/run/output.pb', 'Where to save the resulting file to.')

tf.app.flags.DEFINE_string(
    'dataset_dir', '/home/linux/code/items/dataset/classify', 'Directory to save intermediate dataset files to')
